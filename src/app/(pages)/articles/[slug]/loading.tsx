 ...
 * Renders inside the Suspense fallback boundary, so it mirrors only the inner grid layout
 * without the outer main/container (which is provided by the parent page component).
