 ...
 * Mirrors the two-column layout: article header + content on the left,
 * sidebar placeholder on the right.
	...
	return (
		<main className="px-8 py-12 md:px-16 md:py-16 lg:px-24">
			<div className="mx-auto w-full max-w-[1320.8px]">
				{/* Back button */}
				<div className="mb-8 h-9 w-20 animate-pulse rounded-md bg-foreground/10" />
