...
| [cached-components.instructions.md](.github/instructions/cached-components.instructions.md)     | `src/**/*.tsx`, `src/**/*.ts`                   | `'use cache'` directive, `cacheLife`, `cacheTag`, fetch inside cache scope       |
